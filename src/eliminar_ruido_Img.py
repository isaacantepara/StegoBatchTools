...
def base64(ruta_archivo_binario, nombre_archivo, carpeta_salida, cantidad_ruido=1024):
...
def recuperar_imagenes(carpeta_base64, carpeta_salida):
    ...
    for nombre_archivo in os.listdir(carpeta_base64):
        ...
        base64(ruta_archivo, nombre_archivo_sin_ext, carpeta_salida, cantidad_ruido=1024)
